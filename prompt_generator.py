...
class GPT_prompt_generator:
    ...
    api_key= "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"
    OpenAI = OpenAI()
    client = OpenAI(
    api_key= api_key
    )
